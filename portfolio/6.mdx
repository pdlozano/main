...
import FeaturedImage from "../public/portfolio/6.0.png";
export const meta = {
    title: "Data Cleaning and Engineering",
    description: "This project shows data cleaning skills on a public government dataset. A short exploratory data analysis is also shown in the end.",
    date: new Date("04 Mar 2023"),
    tag: "Data Science",
    urls: [
        {
            name: "Notebook",
            link: "/portfolio/notebook/6.html",
        },
        {
            name: "GitHub",
