...
function Body() {
    return (
        <div className="grid gap-5 md:grid-cols-2 w-11/12 md:w-10/12 mx-auto my-5">
            ...
            <div>
                <h2>About Me</h2>
                <p>My name is David. I am a proud Filipino and a web developer in my free time when I&apos;m not
                    studying. I have been coding for the web since 2017 when I first touched HTML and JS. Today, I code
                    mostly in JS and Python with a very small knowledge of C++.</p>
