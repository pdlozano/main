...
export const meta = {
    title: "We need to start talking about deepfakes",
    description: "Hello",
    date: new Date("28 Jan 2023"),
    draft: true,
}

Lorem ipsum. We need to work on `deepfake`. Hello? 😆😆.

![Alt](https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fcdn.mos.cms.futurecdn.net%2FvCiYBhEfxECz9ZEWX6YuQc-970-80.jpg&f=1&nofb=1&ipt=90a750e4162a76162e4729e4da7576696241ab0b24e1277726ed4935601e66a1&ipo=images)
